...
view model =
  div []
    [ div []
      [ text ("Random boolean: " ++ (toString model.randomBoolean)), br [] []
      , text ("Random int: " ++ (toString model.randomInt)), br [] []
      , text ("Random string: " ++ (toString model.randomString)), br [] []
      , text ("Random list: " ++ (toString model.randomList)), br [] []
      ]
    , button [ onClick GetRandomValues ] [ text "Get randoms" ]
    ]